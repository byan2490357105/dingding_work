...
import { User, Lock, Connection, Message } from '@element-plus/icons-vue'

export default {
  name: 'Profile',
  components: { User, Lock, Connection, Message },
  data() {
    // 确认新密码校验
  ...
  methods: {
    ...
    // 加载当前邮箱（GET /api/profile 返回 email 字段）
    async loadEmail() {
      try {
